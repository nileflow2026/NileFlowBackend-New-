 ...
 *
 * Usage:
 * node createAfricanFactsSchema.js
 */

const { Databases, Permission, Role } = require("node-appwrite");
...
async function createAfricanFactsCollection() {
  try {
    console.log("Setting up African Facts collection attributes...");
    console.log("Collection ID:", AFRICAN_FACTS_COLLECTION);
    ...
    console.error("Error setting up African Facts collection:", error);
  }
}
...
async function createAfricanProverbsCollection() {
  try {
    console.log("\nSetting up African Proverbs collection attributes...");
    console.log("Collection ID:", AFRICAN_PROVERBS_COLLECTION);
    ...
    console.error("Error setting up African Proverbs collection:", error);
  }
}
